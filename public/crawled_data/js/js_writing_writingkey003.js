...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "I am a final year student so I need to find a research a lot of materials such as books and scientific journals.",
};

const questions2_answer = { 
    "question2": "I usually visit libraries, search online databases, and use academic platforms like Google Scholar and JSTOR to find relevant materials. These sources help me gather books, journals, and papers for my research."
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "Hi! Welcome to the club. When and where do you like reading books?",
    "question3_2": "Hi! I would like to give my friend a book. What would you suggest for me to buy?",
    "question3_3": "Online books replace traditional books? What do you think about that?"
};

const questions3_answer = { 
    "question3_1_answer": "I like to read books in the evenings when I can relax. I usually read at home, in my cozy corner, with a cup of tea. It's a great way to unwind after a busy day.",
    "question3_2_answer": "If your friend enjoys fiction, I'd recommend a bestseller like 'The Night Circus.' For non-fiction, something motivational or educational, like 'Atomic Habits,' would be a great choice to inspire them.",
    "question3_3_answer": "Online books are convenient and portable, but they don't fully replace traditional books. The experience of reading a physical book is unique and many still prefer the tactile feel and scent of paper."
};
...
//----------------------------------------------------------------------
const questions4_main = "Dear member, From next month we will no longer be able to continue our offer of one free book every month. Also, because of problems with our delivery service, please expect a wait 4-6 weeks before your order arrives.";
