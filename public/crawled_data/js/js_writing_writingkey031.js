const key_id = "Bộ đề #031";
const club_name = "Technology club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "What do you usually use your laptop for?",
};
const questions2_answer = { 
    "question2": "I usually use my laptop for work, studying, and entertainment. I browse the internet, watch videos, do research, and sometimes play games or connect with friends online."
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "Do you often watch movies on your laptop or go to the theater?",
    "question3_2": "I used to work on a laptop and it stopped and I lost all my notes. Tell me about a bad time with your computer?",
    "question3_3": "Technological improvements have made our lives easier. what do you think?"
};

const questions3_answer = { 
    "question3_1_answer": "I prefer watching movies in the theater because of the large screen and immersive sound. However, I do watch movies on my laptop when I want convenience and comfort at home.",
    "question3_2_answer": "Once, my laptop crashed while I was working on an important project, and I lost all my notes. It was incredibly frustrating, but I learned to back up my data regularly afterward.",
    "question3_3_answer": "Technological improvements have certainly made life easier. With advanced tools, we can communicate faster, work more efficiently, and have access to vast amounts of information right at our fingertips."
};
...
//----------------------------------------------------------------------
const questions4_main = "Dear member, members often post on the website's club. But lately there’s been a few negatives on the other member's post. We are thinking of changing the website to identify anyone who makes a comment. Please give your opinion to fix the situation.";
