const key_id = "Bộ đề #014";
const club_name = "Fitness club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Please talk about the last time you went for a run?",
};
const questions2_answer = { 
    "question2": "The last time I went for a run was last weekend. It felt refreshing, and I ran for about 30 minutes in the park, enjoying the fresh air and nature."
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "I live in a tall building, I usually walk downstairs to exercise, how do you usually exercise?",
    "question3_2": "I usually get up early to run in the morning because I usually get tired in the evening. What about you?",
    "question3_3": "Nowadays, technology makes people's lives easier, but it also makes them lazy and dislike exercise. Do you agree with this opinion?"
};

const questions3_answer = { 
    "question3_1_answer": "I usually exercise by going to the gym or doing home workouts like yoga or bodyweight exercises. I find them effective for staying fit without needing a lot of space or equipment.",
    "question3_2_answer": "I prefer exercising in the evening when I have more energy. I usually go for a jog or take a brisk walk around my neighborhood. It helps me relax after a busy day.",
    "question3_3_answer": "I do agree that technology has made life more convenient, but it often leads to less physical activity. While tech helps in many ways, it’s essential to make time for regular exercise."
};
...
//----------------------------------------------------------------------
const questions4_main = "Dear members, some equipment in the club is old and needs to be replaced. Our club is planning to hold a sponsorship event to raise money for the upgrade of sports equipment. On the other hand, there are also some opinions that the club should increase the membership fee to 50%.";
