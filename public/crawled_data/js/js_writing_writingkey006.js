const key_id = "Bộ đề #006";
const club_name = "Cinema club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "When and how often do you watch films?",
};
const questions2_answer = { 
    "question2": "I usually watch films in the evenings after work. I try to watch at least two movies a week, mostly on weekends when I have more free time." 
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "I like to sit near the screen when I go to the cinema? I never drink or eat anything during the film. What about you?",
    "question3_2": "I don’t like watching old back-and-white. They are boring. I prefer modern films, which do you prefer, and why?",
    "question3_3": "Some people say we don’t need cinemas anymore. We can watch everything on TV or online at home? What do you think about this?"
};

const questions3_answer = { 
    "question3_1_answer": "I prefer sitting closer to the screen for a better experience, and I enjoy some snacks during the film. It helps me relax and enjoy the movie more. How about you?",
    "question3_2_answer": "I also prefer modern films because of the high-quality visuals and advanced technology. They are more engaging and entertaining, while black-and-white films feel less dynamic and harder to connect with.",
    "question3_3_answer": "While watching films online is convenient, I think cinemas offer a unique experience with a large screen and immersive sound. Watching in a theater still feels special and brings people together."
};
...
const question4_2_text = "Write an email to the president of the club (about 120-150 words). Write about your ideas and what you think about the situation.";
