...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Please tell me the last time you took a picture?",
};
const questions2_answer = { 
    "question2": "The last time I took a picture was during a weekend trip to the mountains. I captured the beautiful scenery, with clear skies and vibrant greenery, which was truly breathtaking."
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "Hi! Welcome to the club. How to have a beautiful picture?",
    "question3_2": "I often save my photos as files on my computer or print them out. How do you save your photos?",
    "question3_3": "What skills do you need to take good photos?"
};

const questions3_answer = { 
    "question3_1_answer": "To have a beautiful picture, it's important to focus on lighting, composition, and framing. Also, using the right camera settings and editing afterward can enhance the image's appeal.",
    "question3_2_answer": "I usually save my photos both digitally on cloud storage and on an external hard drive. I also occasionally print them out to create albums or frame my favorite shots.",
    "question3_3_answer": "To take good photos, you need skills in composition, understanding lighting, choosing the right angles, and mastering camera settings. Editing also plays an important role in enhancing the final image."
};
...
//----------------------------------------------------------------------
const questions4_main = "Dear member, the club organizes exhibitions to display the best photographs of club members. This exhibition must be suitable for both the young and the old. Please give suggestions.";
