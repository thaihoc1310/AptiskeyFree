const key_id = "Bộ đề #012";
const club_name = "English club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "•	What do you usually use the internet for?",
};
const questions2_answer = { 
    "question2": "I usually use the internet for browsing social media, watching videos, reading news, shopping online, and researching information for my work or studies."
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "I usually spend 6 hours a day studying English. How do you learn English?",
    "question3_2": "English is a popular language in the world. What are your thoughts on this idea?",
    "question3_3": "When do you usually use English?"
};

const questions3_answer = { 
    "question3_1_answer": "I learn English by practicing speaking, listening to podcasts, reading books, and watching English movies. I also take online courses to improve my grammar and writing skills regularly.",
    "question3_2_answer": "English's popularity is due to its use in international business, education, and communication. It's a global language that connects people across cultures, making it essential for global interaction and understanding.",
    "question3_3_answer": "I usually use English when communicating with friends, reading articles online, watching movies or shows, and during my work. It's also essential when traveling or attending international events."
};



//----------------------------------------------------------------------
const questions4_main = "Nowadays more and more new words and phrases are added to the language, so many people have strong reactions on this issue. Some people gladly accept others argue that there should be rules for language. Write a letter to your friend and the club manager to express your views and explain why so many people react like this.";
