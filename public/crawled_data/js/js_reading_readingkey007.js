...
document.getElementById('question_step').innerHTML = 'Bộ đề #07'; // Bộ 22
const q2_topic = "Mae - The Math Girl";
const q3_topic = "IoT - Internet of Things";

const q4_topic = "Childhood memories";
const q5_topic = "Cultural Exchange";
...
const question2Content = [
    { 
        text: "Mae’s father worked as a nurse, and her mother was a teacher.",
        id: "item1"
    },
    { 
        text: "Her parents motivated Mae to pursue higher education and focus on scientific studies.",
        id: "item2"
    },
    { 
        text: "Mae worked diligently and achieved several remarkable milestones.",
        id: "item3"
    },
    { 
        text: "She later joined a team, contributing her skills and knowledge.",
        id: "item4"
    },
    { 
        text: "Eventually, she had the opportunity to undergo a training program in the United States.",
        id: "item5"
    }
];
...
const question3Content = [
    { 
        text: "The Internet of Things (IoT) links everyday devices to improve their capabilities.",
        id: "item1"
    },
    { 
        text: "Early IoT devices faced limitations due to slow internet speeds and compatibility challenges.",
        id: "item2"
    },
    { 
        text: "High development costs previously slowed the widespread adoption of IoT technology.",
        id: "item3"
    },
    { 
        text: "Nowadays, engineers create smart devices for both residential and industrial applications.",
        id: "item4"
    },
    { 
        text: "Modern IoT systems provide real-time data tracking and automation features.",
        id: "item5"
    }
];
...
const correctAnswersQuestion4 = ['C', 'D', 'A', 'C', 'D', 'A', 'B'];
...
strong2.innerHTML = '<strong>Mẹo nhớ Keyword:</strong>Global → Festivals → Language → Overemphasis → Preservation → Building → Authentic.';

const strong3 = document.createElement('p');
strong3.innerHTML = "<strong>Nhớ theo đoạn văn:</strong> Hiểu biết toàn cầu (<strong>Global</strong>) thúc đẩy các lễ hội văn hóa (<strong>Festivals</strong>) và trao đổi ngôn ngữ (<strong>Language</strong>), nhưng đôi khi có sự tập trung quá mức vào du lịch thương mại (<strong>Overemphasis</strong>). Vì thế, cần quan tâm đến việc bảo tồn văn hóa (<strong>Preservation</strong>), xây dựng sự tôn trọng lẫn nhau (<strong>Building</strong>) và hướng đến trải nghiệm văn hóa chân thực (<strong>Authentic</strong>).";
