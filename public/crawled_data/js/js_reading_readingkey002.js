...
document.getElementById('question_step').innerHTML = 'Bộ đề #02'; // Bộ 17
...
const question2Content = [
    { 
        text: "Before writing about a place, you need to do some research on it.", 
        id: "item1"
    },
    { 
        text: "It is important to learn about the people and the history there carefully.", 
        id: "item2"
    },
    { 
        text: "Even if you can not visit the place, your writing will still look similar to real experiences.", 
        id: "item3"
    },
    { 
        text: "You should also compare that place with your own country.", 
        id: "item4"
    },
    { 
        text: "Such comparisons will make your writing more interesting and meaningful.", 
        id: "item5"
    }
];
...
const question3Content = [
    { 
        text: 'Movies today are very different from movies in the past', 
        id: "item6"
    },
    { 
        text: 'In the old days, films were only in black and white, and sometimes even without sound.', 
        id: "item7"
    },
    { 
        text: "In addition to these technological limits, producers had very low budgets.", 
        id: "item8"
    },
    { 
        text: 'Because of the lack of money, actors also earn little money from acting.', 
        id: "item9"
    },
    { 
        text: 'Nowadays, everything has changed: actors and producers can earn a lot of money from producing films.', 
        id: "item10"
    }
];
