...
document.getElementById('question_step').innerHTML = 'Bộ đề #06'; // Bộ 21
const q2_topic = "Workplace evolution";
const q3_topic = "Music show at the park (Music festivals)";

const q4_topic = "Technology in childhood - Phiên bản 2";
const q5_topic = "Technology advances";
...
const question3Content = [
    { 
        text: "The event was fully planned, financed, and supported by local authorities.",
        id: "item1"
    },
    { 
        text: "As a result, entry was free, and around five thousand people attended.",
        id: "item2"
    },
    { 
        text: "Many attendees arrived early and browsed local shops before the event began.",
        id: "item3"
    },
    { 
        text: "Despite the busy day, workers finished ahead of schedule and watched the famous singer perform.",
        id: "item4"
    },
    { 
        text: "The two-hour performance thrilled the audience, leaving everyone in high spirits.",
        id: "item5"
    }
];
...
const correctAnswersQuestion4 = ['C', 'A', 'B', 'D', 'A', 'C', 'D'];
...
strong2.innerHTML = '<strong>Mẹo nhớ Keyword:</strong> Human-Technology → Intelligent Automation → Education → Digital Interfaces → Access to Technology → Building Innovative → Digital Solutions.';

const strong3 = document.createElement('p');
strong3.innerHTML = "<strong>Nhớ theo đoạn văn:</strong> Công nghệ con người (<strong>Human-Technology</strong>) kết hợp tự động hóa thông minh (<strong>Intelligent Automation</strong>) để cải cách giáo dục (<strong>Education</strong>), tạo ra giao diện kỹ thuật số (<strong>Digital Interfaces</strong>), mang đến sự tiếp cận công nghệ (<strong>Access to Technology</strong>), xây dựng giải pháp sáng tạo (<strong>Building Innovative</strong>) và giải pháp kỹ thuật số (<strong>Digital Solutions</strong>).";
