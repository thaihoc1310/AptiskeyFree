const key_id = "Bộ đề #0";
const club_name = "Nature club 2";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "What do you like doing when you spend time outdoors?",
};
const questions2_answer = { 
    "question2": "I enjoy playing sports like football and basketball, hiking in the mountains, and spending time with friends outdoors, which helps me stay active and healthy."
};
//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "I went for a walk in the forest last month and I got lost. Can you tell me about a time when you got lost?",
    "question3_2": "I like visiting the mountains because they are so peaceful. What kinds of places do you like to visit and why?",
    "question3_3": "Large group holidays in areas of natural beauty are becoming more and more popular. I'm not sure that's a good thing. Do you agree? Why or why not?"
};


const questions3_answer = { 
    "question3_1_answer": "Last year, my friends and I visited a remote beach. After enjoying the view, we wandered off and got lost for a while. It was challenging but an adventure in itself.",
    "question3_2_answer": "I enjoy visiting places like beaches, forests, and lakes. They provide a peaceful atmosphere where I can relax, enjoy nature, and disconnect from the stress of daily life. It's rejuvenating.",
    "question3_3_answer": "I understand the popularity of large group holidays, but I feel they can impact the environment negatively. Smaller, sustainable trips would preserve nature and offer a more personal experience."
};



//----------------------------------------------------------------------
const questions4_main = "Dear Member, this year we are planning a campaign to encourage young children to think more about nature and the natural world. Unfortunately, a lot of children prefer staying indoors and playing computer games. How can we get them to spend more time outdoors and explore? Please send us your ideas for encouraging young people to become more engaged with nature. Also, what do you think is the best way for us to communicate our messages to them?";
const question4_1_text = "Write an email to your friend, who is also a member of the club. Write about your ideas and how to communicate them. Write about 50 words.";
const question4_2_text = "Write an email to the manager of the club. Tell the manager your suggestions for promoting nature to young people and how best to communicate them. Write 120-150 words.";
...
const question4_2_text_answer = `Dear Club Manager,  
