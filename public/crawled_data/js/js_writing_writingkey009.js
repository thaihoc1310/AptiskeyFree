const key_id = "Bộ đề #009";
const club_name = "Computer club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "When and where do you use a computer?",
};

const questions2_answer = { 
    "question2": "I use a computer every day at home and at work. I primarily use it for work tasks, browsing the internet, and staying connected with friends through social media."
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "My grandmother doesn’t know how to use the computer. Your solutions.",
    "question3_2": "The last time you used your computer. Your purpose.",
    "question3_3": "Nowadays people use computers a lot. This is not good. Your opinion."
};

const questions3_answer = { 
    "question3_1_answer": "I would suggest teaching her the basics step by step, starting with simple tasks like browsing the web or using email. It would be helpful to provide a patient, hands-on approach.",
    "question3_2_answer": "The last time I used my computer was to finish some work tasks. I used it for writing reports and responding to emails. It’s an essential tool for productivity in my job.",
    "question3_3_answer": "While computers are useful tools, I believe overuse can lead to physical and mental health issues. It’s important to balance screen time with outdoor activities and personal interactions to maintain overall well-being."
};
...
//----------------------------------------------------------------------
const questions4_main = "The club has a plan to adjust our website in order to attract more members. Your feelings and suggestions";
