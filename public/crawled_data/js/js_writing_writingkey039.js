...
const club_name = "English club 3";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "When do you usually use English?",
};
const questions2_answer = { 
    "question2": "I usually use English when I watch movies, read books, or communicate with friends online. It's also necessary for school and work-related tasks.",
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "Hi! I heard that you attended a club meeting this afternoon. How do you feel about the meeting?",
    "question3_2": "We have weekly meetings on Saturday afternoons. What topic are you expecting us to talk about?",
    "question3_3": "We are thinking of holding some English games next week. Can you suggest some?"
};

const questions3_answer = { 
    "question3_1_answer": "I really enjoyed the club meeting this afternoon. The discussions were engaging, and I liked how everyone shared their ideas. It was a great chance to learn something new.",
    "question3_2_answer": "I'm hoping we will talk about improving our English communication skills. Maybe we could discuss some effective ways to practice speaking or introduce some interesting language games.",
    "question3_3_answer": "For the English games, I suggest playing word association or a spelling bee competition. These games are fun and can help everyone improve their vocabulary and spelling skills."
};
...
const question4_2_text = "Write an email to the president of the club (about 120-150 words). Write about your feelings suggest possible.";
