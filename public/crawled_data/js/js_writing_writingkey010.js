const key_id = "Bộ đề #010";
const club_name = "Cooking club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Tell me about the day and time you can join the club and which food/dish you want to cook.",
};

const questions2_answer = { 
    "question2": "I can join the club on Saturday afternoons. I would love to cook pasta with tomato sauce, or perhaps try making some homemade pizza. I enjoy cooking Italian food." 
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "Hi! Welcome to the club. Why did you decide to join the club?",
    "question3_2": "Hi! What do you think about the club’s price/ membership fee?",
    "question3_3": "How often do you go to the club?"
};

const questions3_answer = { 
    "question3_1_answer": "I decided to join the club because I wanted to meet new people, learn new skills, and participate in interesting activities. It seemed like a fun and engaging community to be a part of.",
    "question3_2_answer": "I think the club’s membership fee is quite reasonable considering the activities and benefits offered. It’s affordable, and the variety of events makes it worth the cost for me.",
    "question3_3_answer": "I usually go to the club twice a week. I try to attend the events that interest me most, such as workshops and social gatherings, to make the most of my membership."
};



//----------------------------------------------------------------------
const questions4_main = "Dear member, All classes will be canceled next week. Because the instructor will go on holiday. Classes will be announced later. Fees won’t be refunded to the participants.";
