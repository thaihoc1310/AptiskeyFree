const key_id = "Bộ đề #029";
const club_name = "Social club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Tell me about your best friend?",
};
const questions2_answer = { 
    "question2": "My best friend is someone who is always supportive and understanding. We share common interests and have fun together, whether it's hanging out or working on projects."
};
...
const questions3 = {
    ...
    "question3_3": "It is much easier to make new friends these days because of computers and mobile phones. Do you agree? Why or why not?"
};

const questions3_answer = { 
    "question3_1_answer": "When I go out with my friends, we often visit cafes, watch movies, or just hang out and chat. It’s always fun to catch up and relax together in a comfortable setting.",
    "question3_2_answer": "Yes, I believe it’s easier for young people to make friends today. Social media and online platforms allow them to meet and connect with others, making it more accessible to build relationships.",
    "question3_3_answer": "I agree that technology makes it easier to meet new people, but it’s important to build deeper connections in person. Online interactions can be helpful but might not always lead to meaningful friendships."
};
...
//----------------------------------------------------------------------
const questions4_main = "Dear members, we would like to organize some monthly face to face meetings. We would like your suggestions about when and where we could meet. It suits both young and older people. Please send us your suggestions and your reasons.";
