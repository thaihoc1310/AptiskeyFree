const key_id = "Bộ đề #021";
const club_name = "Movie club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Why did you join the club?",
};
const questions2_answer = { 
    "question2": "I joined the movie club because I love watching films and discussing them with others. It's a great way to discover new movies and share thoughts with fellow movie enthusiasts."
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "Hi! When and where do you usually watch movies?",
    "question3_2": "I want to make movies for young children. Give me some suggestions?",
    "question3_3": "How do you think technology affects the way we watch movies in the future?"
};

const questions3_answer = { 
    "question3_1_answer": "I usually watch movies in the evenings at home with friends or family. Sometimes, I go to the theater for new releases. I enjoy watching a mix of genres depending on my mood.",
    "question3_2_answer": "For making movies for young children, I suggest focusing on colorful visuals, engaging characters, and simple yet meaningful stories. Keep the content educational, fun, and age-appropriate to hold their attention.",
    "question3_3_answer": "Technology will revolutionize the way we watch movies by offering more immersive experiences through VR and AR. Streaming services will continue to grow, and interactive films may become more common in the future."
};
...
//----------------------------------------------------------------------
const questions4_main = "Dear member, The club will be repaired. Please suggest an alternative meeting or activity.";
