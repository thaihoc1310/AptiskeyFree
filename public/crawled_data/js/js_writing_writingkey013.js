const key_id = "Bộ đề #013";
const club_name = "Film club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Please write some of your favorite films and why do you like watching them?",
};
const questions2_answer = { 
    "question2": "Some of my favorite films are 'Inception' and 'The Dark Knight'. I enjoy them for their complex plots, amazing visuals, and the incredible performances by the actors."
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "Hi. Welcome to the club. How often do you watch films?",
    "question3_2": "Hi. Can you remember the first film you what? What was it like?",
    "question3_3": "What would you like to learn from the film club?"
};

const questions3_answer = { 
    "question3_1_answer": "I watch films about 2-3 times a week, mostly on weekends. I enjoy a variety of genres, from action to drama, and I love discussing them with friends afterward.",
    "question3_2_answer": "The first film I watched was a cartoon when I was very young. It was colorful and exciting, and I still remember how much it fascinated me at that time.",
    "question3_3_answer": "From the film club, I would like to learn more about different film genres, improve my film analysis skills, and engage in discussions that enhance my understanding of storytelling techniques."
};
...
//----------------------------------------------------------------------
const questions4_main = "We are writing to tell you that the guest actor, James Mc Avoy, will unfortunately not be able to give a talk at our next club meeting due to personal reasons. He has requested we reschedule the talk for the next year in either January or March. Please contact the club secretary if you have a preference for one of the two months. Our meeting will take place as usual with a discussion on the advantages and disadvantages of learning on the Internet.";
const question4_1_text = "Write an email to your friend. Write about your feelings and what you would like to do (50 words).";
const question4_2_text = "Write an email the the manager of the club. Write about your feelings and possible alternatives (120 – 150 words)";
