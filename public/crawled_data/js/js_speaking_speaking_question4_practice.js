const questions = [
{
    ...
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: Ở đây, bạn sẽ thay thế bằng tình huống cụ thể liên quan đến câu hỏi.</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: Bạn điền vào cảm xúc hoặc khó khăn khi đối mặt với tình huống đó.</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: Bạn mô tả cảm giác tự hào về kết quả đạt được.</li>" +
    "</ul>"
},
{
...
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: Thay phần này bằng tình huống cụ thể liên quan đến câu hỏi, ví dụ: 'Đặt câu hỏi với giảng viên về một khái niệm khó trong lớp học.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy hơi lo lắng vì tôi không muốn bị cho là chưa chuẩn bị.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Giảng viên đã giải thích rất rõ ràng và điều này giúp tôi hiểu bài tốt hơn.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Đọc một cuốn sách truyền cảm hứng trong một thời gian khó khăn trong cuộc sống của tôi.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy không chắc chắn liệu một cuốn sách có thể giúp tôi cảm thấy tốt hơn.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Cuốn sách đã mang lại cho tôi những bài học quý giá về sự kiên cường, và nó đã giúp tôi vượt qua những thử thách của mình.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Đi thăm một triển lãm nghệ thuật để xem một bức tranh nổi tiếng.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy hào hứng nhưng cũng hơi bối rối vì đây là lần đầu tôi tham gia một triển lãm nghệ thuật.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Các bức tranh thật sự ấn tượng và giúp tôi có cái nhìn sâu sắc hơn về nghệ thuật và sự sáng tạo.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Chọn trường đại học để nộp hồ sơ vì tôi có nhiều sự lựa chọn ở các thành phố khác nhau.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy choáng ngợp vì có quá nhiều lựa chọn tốt.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Tôi đã đưa ra quyết định đúng đắn, và trường đại học tôi chọn thực sự phù hợp với mục tiêu và ước mơ của tôi.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Làm việc nhóm để hoàn thành một dự án nhóm tại công ty.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy hơi lo lắng vì đó là lần đầu tiên tôi làm việc trong một nhóm lớn với những kỹ năng đa dạng.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Chúng tôi đã hoàn thành dự án thành công, và tôi đã học được cách hợp tác hiệu quả với người khác.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Chơi bungee jumping trong một chuyến đi du lịch nước ngoài.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy sợ hãi và lo lắng khi phải nhảy từ độ cao như vậy.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Tôi đã vượt qua nỗi sợ hãi và có một trải nghiệm không thể quên, điều này giúp tôi tăng cường sự tự tin.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Khám phá một khu rừng trong chuyến đi bộ đường dài cùng bạn bè.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Hồi hộp nhưng cũng có chút lo lắng vì không chắc mình sẽ gặp phải gì trong rừng.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Chuyến đi thật tuyệt vời và nó giúp tôi kết nối với thiên nhiên, cảm nhận sự yên bình.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Thi đạt chứng chỉ Aptis và nhận chứng chỉ tiếng Anh của mình.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy lo lắng và không chắc liệu mình có thể hoàn thành bài thi tốt không.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Tôi đã vượt qua bài thi và đạt chứng chỉ, điều này giúp tôi tự tin hơn khi sử dụng tiếng Anh trong công việc.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Học cách sử dụng một phần mềm mới cho công việc.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy hơi choáng ngợp vì không có kinh nghiệm trước đó với phần mềm này.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Tôi đã thành thạo phần mềm này và cải thiện hiệu quả công việc của mình.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Nhận được tin mình đã đậu kỳ thi quan trọng và đạt được mục tiêu.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy lo lắng và hồi hộp khi chờ đợi kết quả.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Tôi đã làm việc chăm chỉ cho kỳ thi và việc đậu kỳ thi giúp tôi tự tin hơn và mở ra nhiều cơ hội mới.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: '
'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Khi duy trì thói quen ngủ đều đặn, tôi cảm thấy tràn đầy năng lượng và tập trung hơn trong suốt cả ngày.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Tham gia khóa học tiếng Anh để cải thiện kỹ năng ngôn ngữ của tôi.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy lo lắng vì tôi không tự tin vào kỹ năng nói của mình.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Tôi đã tự tin hơn khi nói và viết tiếng Anh, và tôi có thể giao tiếp tốt hơn.'</li>" +
    "</ul>"
},
{
    ...
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Giúp một người bạn chuyển đến căn hộ mới.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy mệt mỏi vì tôi đã có lịch trình bận rộn trong ngày hôm đó.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Bạn tôi rất cảm kích vì sự giúp đỡ của tôi, và chúng tôi đã có thời gian vui vẻ trong suốt quá trình chuyển nhà.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Vội vàng để bắt chuyến bay sau khi bị trễ.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy căng thẳng và lo lắng vì tôi không còn nhiều thời gian.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Tôi đã kịp chuyến bay và học được bài học về việc lập kế hoạch thời gian cẩn thận hơn cho những chuyến đi tiếp theo.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Chọn ngành học từ nhiều lựa chọn khác nhau.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy bối rối và không chắc chắn về con đường nào là tốt nhất cho mình.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Cuối cùng tôi đã chọn một ngành học phù hợp với sở thích và tôi rất hào hứng bắt đầu việc học.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Nhận câu hỏi khó trong một buổi phỏng vấn xin việc.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy lo lắng và không chắc chắn về cách trả lời câu hỏi.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Tôi đã trả lời câu hỏi một cách rõ ràng và chu đáo, và gây ấn tượng với người phỏng vấn.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Học cho một kỳ thi quan trọng đòi hỏi rất nhiều sự chuẩn bị.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy choáng ngợp vì khối lượng tài liệu tôi cần phải ôn tập.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Tôi đã vượt qua kỳ thi với kết quả xuất sắc và học được giá trị của sự chăm chỉ và kiên trì.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Lên kế hoạch cho một sự kiện lớn, chẳng hạn như tổ chức bữa tiệc sinh nhật cho một người bạn.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy choáng ngợp với rất nhiều chi tiết và công việc cần phải làm.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Sự kiện đã thành công rực rỡ và mọi người đều có khoảng thời gian tuyệt vời.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Muốn mua một chiếc laptop mới nhưng không đủ tiền lúc đó.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy thất vọng và chán nản vì tôi thực sự cần chiếc laptop đó.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Cuối cùng tôi đã tiết kiệm đủ tiền và mua được chiếc laptop, điều này đã giúp tôi rất nhiều trong công việc và học tập.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Đi chuyến du lịch dài đến một thành phố xa.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy hào hứng nhưng cũng hơi mệt mỏi vì chuyến đi dài và vất vả.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Tôi đã có một thời gian tuyệt vời khi khám phá thành phố, trải nghiệm nền văn hóa mới và thư giãn.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Thăm một tòa nhà chọc trời nổi tiếng trong chuyến đi đến thành phố lớn.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy hào hứng nhưng cũng hơi lo lắng vì độ cao của tòa nhà.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Tôi đã có một trải nghiệm tuyệt vời khi chiêm ngưỡng toàn cảnh thành phố từ đỉnh tòa nhà.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Gặp một cơn mưa to trong chuyến đi bộ đường dài trên núi.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy lo lắng và khó chịu vì mưa to đột ngột.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Cuối cùng tôi đã tiếp tục chuyến đi một cách an toàn, và tôi học được bài học về việc luôn chuẩn bị sẵn sàng cho thời tiết bất ngờ.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Nhận tin vui về việc được nhận vào trường đại học mà mình mơ ước.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy sốc và vui sướng vì tôi đã chờ đợi kết quả này rất lâu.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Tôi đã đạt được điều mà tôi đã làm việc rất chăm chỉ, và điều này mở ra nhiều cơ hội thú vị cho tôi.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Được yêu cầu giúp một đồng nghiệp với công việc mà tôi không thích.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy miễn cưỡng và không hứng thú khi phải làm công việc đó.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Tôi đã giúp đỡ đồng nghiệp và điều này giúp tôi xây dựng mối quan hệ tốt hơn với các đồng đội.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Bị đối xử thô lỗ bởi một người lạ trong cửa hàng.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy tức giận và khó chịu vì hành vi thiếu lịch sự đó.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Tôi đã giữ bình tĩnh, xử lý tình huống một cách điềm tĩnh và tránh làm tình hình trở nên căng thẳng hơn.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Đi du lịch đến một thành phố ven biển xinh đẹp.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy hào hứng nhưng cũng hơi lo lắng vì đây là lần đầu tiên tôi đến thăm nơi này.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Thành phố rất tuyệt vời với những bãi biển đẹp, món ăn ngon và người dân thân thiện, tạo nên một chuyến đi khó quên.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Muốn mua một chiếc điện thoại mới nhưng không đủ tiền lúc đó.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy thất vọng và khó chịu vì tôi thực sự cần chiếc điện thoại đó.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Cuối cùng tôi đã tiết kiệm đủ tiền và mua được chiếc điện thoại, điều này đã giúp tôi học được sự kiên nhẫn và lập kế hoạch tài chính tốt hơn.'</li>" +
    "</ul>"
},
{
    ...
    "<strong>Giải thích chi tiết:</strong><br>" +
    "<ul>" +
    "<li><strong>[Tình huống cụ thể từ câu hỏi]</strong>: 'Thăm một người bạn thân vừa chuyển đến thành phố mới.'</li>" +
    "<li><strong>[Miêu tả cảm xúc hoặc khó khăn]</strong>: 'Cảm thấy hào hứng nhưng cũng hơi lo lắng vì đây là lần đầu tiên tôi đến thăm nơi ở mới của họ.'</li>" +
    "<li><strong>[Miêu tả cảm giác thành công hoặc bài học rút ra]</strong>: 'Chúng tôi đã có một khoảng thời gian tuyệt vời cùng nhau, kết nối lại và chia sẻ những kỷ niệm, và tôi được chứng kiến cuộc sống mới của họ tại thành phố này.'</li>" +
    "</ul>"
}
];
...
function updateRecordBtn(recording) {
    ...
    if (recording) {
        const mins = Math.floor(recordTimeLeft / 60);
        const secs = recordTimeLeft % 60;
        const timeStr = mins > 0
            ? `${mins}:${secs.toString().padStart(2, '0')}`
            : `${secs}s`;
        btn.innerHTML = `<i class="bi bi-stop-circle-fill"></i> Stop (${timeStr})`;
...
function showAnswer() {
    const box  = document.getElementById('answerBox1');
    const text = document.getElementById('answerText1');

    if (answerBoxVisible) {
        box.style.display = 'none';
        answerBoxVisible = false;
    } else {
        text.innerHTML = questions[currentIndex].answer1;
...
function toggleRead() {
    ...
    const text = document.getElementById('answerText1').innerText.trim();
    if (!text) return;
    ...
    const btn = document.getElementById('readBtn1');
    btn.innerHTML = '<i class="bi bi-stop-fill"></i> Dừng';
    btn.classList.add('reading');

    utterance.onend = function() { resetReadBtn(); };
    utterance.onerror = function() { resetReadBtn(); };
...
document.addEventListener('DOMContentLoaded', function () {
    if (!document.getElementById('recordBtn')) return;
    renderQuestion();
