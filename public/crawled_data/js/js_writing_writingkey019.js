...
const questions2_answer = { 
    "question2": "In my free time, I enjoy reading books, listening to music, and practicing languages. I also love traveling and learning about different cultures to improve my language skills."
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "Why did you choose this course?",
    "question3_2": "How have you found the course so far? What’s been difficult?",
    "question3_3": "What are you hoping to do when you finish the course?"
};

const questions3_answer = { 
    "question3_1_answer": "I chose this course because I want to improve my language skills, especially in speaking and writing. It seemed like a great opportunity to practice with others and expand my knowledge.",
    "question3_2_answer": "The course has been quite interesting so far, but I find the grammar lessons a bit challenging. However, I enjoy the conversations and interactive activities which make learning more fun.",
    "question3_3_answer": "After finishing the course, I hope to become fluent and confident in speaking the language. I also plan to use it for travel and potentially work opportunities in countries where it's spoken."
};
...
//----------------------------------------------------------------------
const questions4_main = "You are taking an English Course at the American Dream Center. After studying for 2 months, you find the course effective and useful.";
const question4_1_text = "Write a short email to your friend (about 50 words). Write about your feelings and recommend the course to her/him .";
const question4_2_text = "Write an email to the president of the club (about 120-150 words). You have registered for an English course at A Level Speaking Center but in the end you can’t arrange the time to attend the course. Write about your feelings, the reason why you can’t attend and what you would like to do.";
