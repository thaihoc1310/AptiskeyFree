const key_id = "Bộ đề #008";
const club_name = "Community club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Why did you join this Community club?",
};

const questions2_answer = { 
    "question2": "I joined the Community club to meet new people, participate in activities, and contribute to local causes. I enjoy being part of a group that makes a positive impact." 
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "My friend wants to go to the hair salon, but her car isn't working. Can you suggest some ways for her to get there?",
    "question3_2": "Volunteering provides great learning opportunities and helps others a lot. Do you agree with this?",
    "question3_3": "Do you agree with the view that volunteering is a form of learning, especially for young people? Why?"
};

const questions3_answer = { 
    "question3_1_answer": "She can use public transportation or take a taxi. Alternatively, she could ask a friend or family member for a ride, or even use a ride-sharing service like Uber or Lyft.",
    "question3_2_answer": "Yes, volunteering not only helps others but also provides valuable learning experiences. It teaches practical skills, empathy, and the importance of contributing to the community, benefiting both the volunteer and those served.",
    "question3_3_answer": "I agree that volunteering is a form of learning, especially for young people. It offers hands-on experiences, teaches responsibility, and fosters important social skills, all of which are crucial for personal and professional development."
};



//----------------------------------------------------------------------
const questions4_main = "Dear Member, Our club needs support with several tasks this year. First, we need more members who can actively participate in our ongoing projects. Second, we are looking for creative ideas to develop new activities. Could you share some suggestions with us to help support our projects this year?";
const question4_1_text = "Write a short email to your friend (about 50 words). Write about your feelings and what you would like to do.";
const question4_2_text = "Write an email to the president of the club (about 120-150 words). Write about your feelings and what you would like to do.";
