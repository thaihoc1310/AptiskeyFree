const key_id = "Bộ đề #036";
const club_name = "Writing club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Tell me about the last time you wrote something.",
};
const questions2_answer = { 
    "question2": "The last time I wrote something was when I completed a project report for work. It took some time, but I was satisfied with the outcome and learned new things."
};
...
const questions3 = {
    ...
    "question3_3": "There are many people who like to write, but only a few become writers. What makes a successful writer?"
};

const questions3_answer = { 
    "question3_1_answer": "I usually write at home in a quiet space. I find it helps me concentrate better, allowing me to focus on my thoughts without distractions like noise or crowds.",
    "question3_2_answer": "I prefer typing because it's faster and more efficient. I can also easily edit and organize my work. However, I sometimes enjoy handwriting for its personal touch and slower pace.",
    "question3_3_answer": "A successful writer combines creativity, persistence, and a deep understanding of their audience. It’s not just about writing well, but also about being dedicated, disciplined, and constantly improving their craft."
};



//----------------------------------------------------------------------
const questions4_main = "Dear members, many people complain that the website is unprofessional and difficult to use. Please send us your suggestions.";
