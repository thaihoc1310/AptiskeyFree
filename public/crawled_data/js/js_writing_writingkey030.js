const key_id = "Bộ đề #030";
const club_name = "Sports club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Why did you decide to join the club?",
};
const questions2_answer = { 
    "question2": "I joined the sports club to stay fit, meet new people, and enjoy playing sports. I love being active, and this club provides a great opportunity to do so regularly."
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "When was the last time you played sports?",
    "question3_2": "I usually play sports with my friends and watch sports programs. What about you?",
    "question3_3": "I like playing sports with my friend but my brother likes playing sports alone. What do you think about this issue?"
};

const questions3_answer = { 
    "question3_1_answer": "The last time I played sports was last weekend. I went jogging in the park with a friend. It felt refreshing and helped me clear my mind after a busy week.",
    "question3_2_answer": "I also play sports with my friends and enjoy watching sports events on TV. It’s a great way to bond with others and stay motivated to stay active and healthy.",
    "question3_3_answer": "I think it’s perfectly fine for your brother to enjoy playing sports alone if that’s what he prefers. People have different preferences, and some enjoy solitary activities for peace and focus."
};
...
//----------------------------------------------------------------------
const questions4_main = "Dear members, the club needs suggestions about the organization of a sports competition for young members.";
