const key_id = "Bộ đề #027";
const club_name = "Reading club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "When was the last time you read a book and how was the book?",
};
const questions2_answer = { 
    "question2": "The last time I read a book was last week. It was a mystery novel, and I enjoyed it a lot. The plot was exciting, and the characters were very engaging."
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "I like reading sports magazines. What genre of books do you like to read? Why?",
    "question3_2": "I have a lot of books for my studies, but I can't remember everything I read. Do you have any suggestions for me?",
    "question3_3": "Children nowadays prefer playing games to reading books. Do you think this is worrying, why?"
};

const questions3_answer = { 
    "question3_1_answer": "I enjoy reading fiction, especially mystery and fantasy books. I love how these genres allow me to escape into different worlds and stimulate my imagination with complex plots and characters.",
    "question3_2_answer": "To retain information, try summarizing key points after reading, and review your notes regularly. Additionally, breaking the material into smaller sections and studying in intervals can improve memory retention.",
    "question3_3_answer": "It is worrying that children prefer playing games over reading, as reading helps with cognitive development, language skills, and imagination. We should encourage children to balance both activities for their growth."
};
...
//----------------------------------------------------------------------
const questions4_main = "The club was invited to contribute to the design of the national library. Most people say that the library is a boring place and don't use it often. We need to make the library a modern and exciting place that attracts both young and old. Please contribute your suggestions.";
