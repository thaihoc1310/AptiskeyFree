...
document.getElementById('question_step').innerHTML = 'Bộ đề #11'; // Bộ 26
const q2_topic = "Healthy Eating";
const q3_topic = "Wellness Fair";

const q4_topic = "Volunteering";
const q5_topic = "Mountain (phiên bản 2)";
...
const question2Content = [
    { 
        text: "In the past, many meals were high in sugar and unhealthy fats.",
        id: "item1"
    },
    { 
        text: "Years ago, limited access to fresh produce made healthy eating more difficult.",
        id: "item2"
    },
    { 
        text: "Modern diets now focus on fresh, whole foods instead of processed ones.",
        id: "item3"
    },
    { 
        text: "Nutritionists today teach people how to plan balanced and nutritious meals.",
        id: "item4"
    },
    { 
        text: "Nowadays, mobile apps help users track calories and discover healthy recipes.",
        id: "item5"
    }
];
...
const question3Content = [
    { 
        text: "The wellness fair took place on Saturday afternoon, encouraging people to adopt healthier lifestyles.",
        id: "item1"
    },
    { 
        text: "More than 60 (con số bất kỳ) participants joined the event, with Dr. A (tên người) leading an engaging fitness workshop.",
        id: "item2"
    },
    { 
        text: "The fair also included activities like cooking demonstrations, mindfulness sessions, and a fun run.",
        id: "item3"
    },
    { 
        text: "After the workshops, prizes were awarded to participants who created the most creative health posters.",
        id: "item4"
    },
    { 
        text: "Families enjoyed tasting healthy snacks and discovering practical tips for better overall wellness.",
        id: "item5"
    }
];
...
// 13. Câu 13 - Volunteering (Phiên bản mới) -- cập nhật 9/4/2026
const question4Text = [
...
const correctAnswersQuestion4 = ['D', 'A', 'B', 'C', 'B', 'C', 'D'];
