const key_id = "Bộ đề #037";
const club_name = "Fashion club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "When was the last time you went shopping for clothes?",
};
const questions2_answer = { 
    "question2": "The last time I went shopping for clothes was last weekend. I bought a couple of t-shirts and a jacket for the upcoming season.",
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "Some people like to buy clothes to try on themselves. Some prefer to buy online. How do you like it and why?",
    "question3_2": "Hi! Why did you decide to join the club?",
    "question3_3": "Why do people like fashion?"
};

const questions3_answer = { 
    "question3_1_answer": "I prefer to buy clothes online because it’s more convenient and I can easily compare prices and styles. I also like reading reviews before making a purchase decision.",
    "question3_2_answer": "I decided to join the fashion club because I am passionate about fashion trends and styling. I wanted to meet like-minded individuals and enhance my knowledge about the fashion industry.",
    "question3_3_answer": "People like fashion because it allows them to express their creativity and individuality. It’s a way to stay connected to current trends, and for many, it’s also a form of art and self-confidence."
};
...
//----------------------------------------------------------------------
const questions4_main = "We are going to hold an event with a famous designer. It needs to be suitable for both the young and the old. Please give your ideas";
