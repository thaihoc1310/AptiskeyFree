const key_id = "Bộ đề #007";
const club_name = "College club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Please tell us about the days and times you can attend courses and what you would like to study?",
};
const questions2_answer = { 
    "question2": "I am available on weekends, mainly on Saturday afternoons. I would love to study painting, especially focusing on modern art techniques and experimenting with different mediums." 
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "Hi! Welcome to the college. What course are you doing and why did you choose it?",
    "question3_2": "Welcome! How do you feel about the college so far?",
    "question3_3": "Did you hear that the college sports club has closed? What do you think about this?"
};


const questions3_answer = { 
    "question3_1_answer": "I’m studying graphic design because I’ve always been passionate about creativity and visual communication. This course will help me develop my skills and open up career opportunities in the creative industry.",
    "question3_2_answer": "So far, I’m really enjoying the college. The campus is vibrant and welcoming, and I’ve met some friendly people. The professors are knowledgeable and make learning engaging, which I appreciate.",
    "question3_3_answer": "Yes, I heard about the sports club closing. It's disappointing because many students enjoyed the activities and it was a great way to stay active. I hope they reconsider or offer alternatives in the future."
};
...
//----------------------------------------------------------------------
const questions4_main = "We are writing to inform you that the end of course exams will now take place two weeks earlier than originally planned. You exam, which was scheduled for the 21st of next month, will now take place on the 7th of next month. We apologize for any difficulty this may cause.";
const question4_1_text = "Write a short email to your friend (about 50 words). Tell them what you think the college should do about the situation.";
const question4_2_text = "Write an email to the president of the club (about 120-150 words). Tell them what you think the college should do about the situation.";
