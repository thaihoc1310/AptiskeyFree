...
const questions2_answer = { 
    "question2": "I'm excited to join the Beautiful Homes Club because I love decorating and want to make my home more beautiful and cozy for my family to enjoy.", 
};
//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "I have a bad relationship with my neighbors because they often make noise. Tell me how is your relationship with your neighbors?",
    "question3_2": "Do you prefer living in old buildings or modern buildings? Why?",
    "question3_3": "The house should be designed in a way that is good for the environment. Do you agree?"
};

const questions3_answer = { 
    "question3_1_answer": "I have a good relationship with my neighbors. We often help each other out and respect each other's space, so there are rarely any conflicts. Communication is key in maintaining a peaceful atmosphere.",
    "question3_2_answer": "I prefer living in modern buildings because they tend to have better facilities, are more energy-efficient, and are designed with current trends in mind. Old buildings, though charming, often lack these features.",
    "question3_3_answer": "Yes, I completely agree. Designing houses with environmental considerations, such as using sustainable materials, energy-efficient systems, and reducing waste, can help minimize our ecological footprint and promote a healthier planet."
};



//----------------------------------------------------------------------
const questions4_main = "Dear member, The cost of maintaining old building is very high and these building take up a lot of space. The government has a proposal that we knock down old buildings and build more modern blocks.";
...
const question4_2_text_answer = `Dear President, 
