...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Tell me a painting or a photo that you like",
};
const questions2_answer = { 
    "question2": "I really like the painting Starry Night by Vincent van Gogh. The colors and swirls in the sky make me feel calm and inspired to create art.", 
};
//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "I kept a painting for a long time. Tell me a thing that you have had for a long time.",
    "question3_2": "I would like to learn painting, but I have not found an effective way. Should I take a course at my local college? Please, give me some advice.",
    "question3_3": "Street art – where people paint on the building – is becoming popular. However, some people criticize that it is bad. What is your opinion?"
};

const questions3_answer = { 
    "question3_1_answer": "I’ve had my old sketchbook for years. It holds a lot of memories, sketches from different stages of my life, and always reminds me of how much my art has evolved over time.",
    "question3_2_answer": "If you're serious about learning painting, taking a course at your local college could be a great idea. Structured lessons with an experienced instructor can really boost your skills and provide useful feedback.",
    "question3_3_answer": "I think street art can be a beautiful form of expression, but it also depends on the context and location. It’s important to respect the space, but when done well, it can really enhance a community's atmosphere."
};



//----------------------------------------------------------------------
const questions4_main = "Dear all members, The Art Club is organizing a talk to the public to attract more attention. We are going to invite an artist to give a talk to members. As a member of our club, could you give us an artist to join our talk and what topic should they share to gain more attention. We would like to have more both young and elderly members.";
const question4_1_text = "Write a short email to your friend (about 50 words). Tell your friend your feelings about this and what you plan to do.";
const question4_2_text = "Write an email to the president of the club (about 120-150 words). Tell them your thoughts about this and what you would like to do.";
