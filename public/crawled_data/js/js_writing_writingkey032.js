const key_id = "Bộ đề #032";
const club_name = "Television club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Do you usually watch TV?",
};
const questions2_answer = { 
    "question2": "I don't watch TV often, but I enjoy watching movies or series occasionally. I prefer streaming services because they offer more flexibility in what to watch."
};
...
const questions3_answer = { 
    "question3_1_answer": "When I watch TV, I like to relax and enjoy the show with a snack. Sometimes, I also multitask by browsing the internet or chatting with friends while watching.",
    "question3_2_answer": "I enjoy watching TV with others, especially family or friends. It’s more fun to share reactions and discuss the plot, but I also enjoy some solo time with my favorite shows.",
    "question3_3_answer": "It's not good for children to watch too much TV. It can lead to a sedentary lifestyle and affect their development. It’s important for kids to engage in other activities as well."
};



//----------------------------------------------------------------------
const questions4_main = "Dear members, we need to set up an event and choose a place so that foreigners can attend. Please give your suggestions.";
