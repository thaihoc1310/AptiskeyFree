...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "The last time you went for a walk?",
};
const questions2_answer = { 
    "question2": "The last time I went for a walk was yesterday evening. I walked in the park, enjoyed the fresh air, and relaxed while watching the sunset. It was very refreshing."
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "I often go for a walk. What about you?",
    "question3_2": "I prefer to go to the countryside for a walk. Walking in the city is stressful and noisy. What do you think?",
    "question3_3": "In the past, people walked long distances as part of their lives. These days, they don't walk anymore. Why?"
};

const questions3_answer = { 
    "question3_1_answer": "I also enjoy going for walks, especially in nature. I find it helps me relax, clear my mind, and stay active. Walking is a peaceful way to connect with the environment.",
    "question3_2_answer": "I agree with you. The countryside offers a much more peaceful environment for walking compared to the city. The noise and traffic in urban areas can make walking stressful and less enjoyable.",
    "question3_3_answer": "These days, many people rely on cars and public transport for convenience and speed. With modern technology, walking has become less necessary for most daily activities, leading to a more sedentary lifestyle."
};
...
//----------------------------------------------------------------------
const questions4_main = "Dear members, The club has planned to organize a walk across European countries. There were a few members of the group who suggested it, but it was said that it was unrealistic. Please send us your suggestions and your reasons.";
