const key_id = "Bộ đề #025";
const club_name = "Outdoor club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Which outdoor activities do you like? Why?",
};
const questions2_answer = { 
    "question2": "I enjoy hiking, cycling, and playing badminton. These activities help me stay active, relax, and enjoy nature. I also love the social aspect of outdoor sports with friends."
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "Hi! Welcome to the club. Tell me about the outdoor activities in the bad weather",
    "question3_2": "Hi! Please give your ideas and advice for hiking?",
    "question3_3": "What are the most popular outdoor activities in your country?"
};

const questions3_answer = { 
    "question3_1_answer": "In bad weather, indoor activities like indoor cycling, gym workouts, or even indoor rock climbing are great alternatives. You can still stay active and have fun while staying dry.",
    "question3_2_answer": "For hiking, I recommend wearing comfortable shoes, carrying enough water, and checking the weather forecast. It’s important to pace yourself and carry a first-aid kit, especially on longer hikes.",
    "question3_3_answer": "In my country, football, badminton, and cycling are very popular outdoor activities. Many people also enjoy hiking, running, and going to the beach, especially during the warm months."
};
...
//----------------------------------------------------------------------
const questions4_main = "Dear member, The club organizes travel in the summer. Do you want to go to the mountains or the coast?  Please give a suggestion for both young and old people.";
