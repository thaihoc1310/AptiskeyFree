...
const questions2_answer = { 
    "question2": "I live in Hanoi, the capital of Vietnam. It's a bustling city known for its rich history, beautiful lakes, ancient temples, and vibrant street food culture."
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "You have to stay in the bedroom but have to share with your brother. How do you feel?",
    "question3_2": "It is better to live in the city than in the countryside. Do you agree? Why?",
    "question3_3": "It is better to live in the city than in the countryside. Do you agree? Why?"
};

const questions3_answer = { 
    "question3_1_answer": "Sharing a bedroom with my brother can be challenging, but it also has its benefits. We get to spend time together, and it helps build a stronger bond despite the limited space.",
    "question3_2_answer": "Living in the city offers many conveniences such as better job opportunities, healthcare, and entertainment. However, the countryside provides peace, fresh air, and a slower pace of life, which some people prefer.",
    "question3_3_answer": "I agree that living in the city has its advantages, like access to modern amenities and social opportunities. However, I also appreciate the tranquility and natural beauty that the countryside offers."
};
