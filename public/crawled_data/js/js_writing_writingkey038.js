const key_id = "Bộ đề #380";
const club_name = "English club 2";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "When do you usually have to come into contact with English?",
};
const questions2_answer = { 
    "question2": "I usually come into contact with English when I watch movies, read books, or communicate with friends online. It's also necessary for work and school tasks.",
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "Tell me about your English learning experience?",
    "question3_2": "I can read and write, but I can't speak English. Do you have any advice for me?",
    "question3_3": "English is a popular language in the world. What are your thoughts on this opinion?"
};

const questions3_answer = { 
    "question3_1_answer": "My English learning experience has been quite challenging but rewarding. I started with basic grammar and vocabulary, then gradually moved on to speaking and listening practice through movies, books, and conversations.",
    "question3_2_answer": "I suggest practicing speaking regularly, even if it's with yourself or language exchange partners. Listening to English podcasts and mimicking native speakers can help improve pronunciation and fluency in speaking.",
    "question3_3_answer": "I agree that English is a global language. Its widespread use in business, media, and education makes it essential for communication across cultures, providing more opportunities for travel and career advancement."
};



//----------------------------------------------------------------------
const questions4_main = "The english club will organize a talk to attract both old and young people. Please give your opinions.";
