...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "What do you usually talk about with your friend?",
};
const questions2_answer = { 
    "question2": "I usually talk with my friends about school, hobbies, and future plans. Sometimes we also share funny stories, discuss films, or chat about our favorite music together." 
};


//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "There are many ways to follow the news nowadays. How do you learn about world issues?",
    "question3_2": "I will take part in a debate in front of 50 people next week. How can I make a good impression?",
    "question3_3": "Before making a decision about an issue, you should consider both sides of it. What do you think about this?"
};


const questions3_answer = { 
    "question3_1_answer": "I usually keep up with world issues by reading news articles, watching documentaries, and following updates on social media. I also listen to podcasts and discussions to get a broader perspective.",
    "question3_2_answer": "To make a good impression, stay calm, confident, and well-prepared. Make eye contact, speak clearly, and back up your arguments with facts. Engaging with the audience and being respectful is key.",
    "question3_3_answer": "I completely agree. Considering both sides of an issue allows for a more balanced perspective, helps make informed decisions, and shows an open-minded approach. It’s crucial for critical thinking."
};
...
//----------------------------------------------------------------------
const questions4_main = "Dear member, please give two important benefits of learning debate and speaking in public to attract new members.";
