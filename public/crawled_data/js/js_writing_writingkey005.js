const key_id = "Bộ đề #005";
const club_name = "Car club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Do you usually travel by car?",
};
const questions2_answer = { 
    "question2": "Yes, I usually travel by car, especially for trips to places that are not easily accessible by public transport. It’s more convenient and comfortable, especially for long distances.", 
};
//----------------------------------------------------------------------
const questions3 = {
...
const questions3_answer = { 
    "question3_1_answer": "I once traveled by car to a nearby beach. It was a scenic drive, and we stopped at some small towns along the way. The trip was smooth and enjoyable, with great conversations and beautiful views.",
    "question3_2_answer": "One memorable car trip was when my family drove to the mountains. We played music, shared stories, and had fun stops for snacks. It was one of those trips that felt timeless and unforgettable.",
    "question3_3_answer": "Whether to take public transportation or buy a car depends on your needs. If you live in a city with good transport, public transit may be better. However, owning a car gives flexibility and convenience for trips."
};
...
//----------------------------------------------------------------------
const questions4_main = "There will be a car program running across Europe. The program invites the Car Club to send 2 representatives (1 main driver and 1 passenger) and both must have good driving skills.";
const question4_1_text = "Write a short email to your friend (about 50 words). Do you have any suggestions for the above positions.";
const question4_2_text = "Write an email to the president of the club (about 120-150 words). Do you have any suggestions for the above positions.";
