...
const questions2_answer = { 
    "question2": "I’m interested in travel because it allows me to experience different cultures, try new foods, and explore beautiful landscapes. It’s a great way to broaden my perspective and learn."
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "Tell me a time you had a trip in bad weather.",
    "question3_2": "Traveling a long distance by some means of transportation is not good for the environment? Do you agree?",
    "question3_3": "What are the most interesting places to visit in your country?"
};

const questions3_answer = { 
    "question3_1_answer": "I once went on a hiking trip, and the weather turned bad with heavy rain and wind. Despite the tough conditions, we continued, and it became an unforgettable adventure. The weather made it more challenging but memorable.",
    "question3_2_answer": "Yes, I agree that traveling long distances by transportation, especially air travel, negatively impacts the environment due to high carbon emissions. It's important to consider alternatives like trains or more eco-friendly options to reduce harm.",
    "question3_3_answer": "Some of the most interesting places to visit in my country include Ha Long Bay, the ancient town of Hoi An, and the bustling city of Ho Chi Minh, each offering a unique cultural and natural experience."
};
...
//----------------------------------------------------------------------
const questions4_main = "Dear members, Travel club is planning to encourage tourists to visit an area. We also want visitors coming to our areas to behave politely. Please raise your voice and give some suggestions for this plan.";
