const key_id = "Bộ đề #023";
const club_name = "Music club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "What do you usually do when you listen to music?",
};
const questions2_answer = { 
    "question2": "When I listen to music, I usually relax, close my eyes, and enjoy the rhythm. Sometimes, I sing along or focus on the lyrics to understand the song better."
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "There are songs that make me relax and there are songs that make me sad. What about you?",
    "question3_2": "Playing loud music annoys people around you, what do you think?",
    "question3_3": "I want to learn how to play music and I want to find a good teacher. Can you give me some advice?"
};

const questions3_answer = { 
    "question3_1_answer": "I agree! Some songs really help me relax, especially slow instrumental music. But there are also songs that bring back memories and make me feel sad, depending on the mood.",
    "question3_2_answer": "I think playing loud music can be disruptive, especially in shared spaces. It's important to respect others by using headphones or keeping the volume at a reasonable level when possible.",
    "question3_3_answer": "To learn music, I recommend starting with simple instruments like piano or guitar. Look for a teacher who can adapt to your learning pace. Online lessons or local music schools are good options."
};
...
//----------------------------------------------------------------------
const questions4_main = "Dear members, The club wants to find volunteers to organize the event. The club does not require experience but you need to be free in the evenings.";
const question4_1_text = "Write a short email to your friend (about 50 words). Write an email about why you want to be a volunteer and contribute your ideas to the event.";
const question4_2_text = "Write an email to the president of the club (about 120-150 words). Write an email about why you want to be a volunteer and contribute your ideas to the event.";
