const key_id = "Bộ đề #022";
const club_name = "Museum club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Tell me the last time you went to a museum?",
};
const questions2_answer = { 
    "question2": "The last time I went to a museum was last month. I visited the History Museum in my city, and it was fascinating to learn about the culture and artifacts."
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "Please talk about the first museum you visited when you were a child?",
    "question3_2": "What kind of museum do you like?",
    "question3_3": "Nowadays, many museums use technology to create online exhibitions. Do you think that will be successful?"
};

const questions3_answer = { 
    "question3_1_answer": "The first museum I visited was a children's museum. I remember being fascinated by the interactive exhibits and learning about science and nature in a fun, hands-on way. It left a lasting impression.",
    "question3_2_answer": "I like museums that focus on history and culture, especially those that showcase ancient artifacts or art. I enjoy learning about the past and how it shapes our present world.",
    "question3_3_answer": "I believe online exhibitions can be very successful, especially in making museums more accessible. However, physical visits will still offer a more immersive and engaging experience that technology can't fully replicate."
};
...
//----------------------------------------------------------------------
const questions4_main = "Dear members, Currently, the museum club is considering that members must pay a fee to visit the museum.";
const question4_1_text = "Write a short email to your friend (about 50 words). Please give your opinions.";
const question4_2_text = "Write an email to the president of the club (about 120-150 words). Please give your opinions.";
