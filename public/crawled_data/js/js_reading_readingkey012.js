...
document.getElementById('question_step').innerHTML = 'Bộ đề #12'; // Bộ 26
const q2_topic = "Busy coffee shop";
const q3_topic = "My visit to a new coffee shop";

const q4_topic = "Career";
...
const question2Content = [
    { 
        text: "The café was very crowded when the customer arrived.",
        id: "item1"
    },
    { 
        text: "The staff helped them find a table and handed them a menu.",
        id: "item2"
    },
    { 
        text: "The customer was surprised because the menu was different from what they had expected.",
        id: "item3"
    },
    { 
        text: "They decided to order the most expensive item — a sandwich.",
        id: "item4"
    },
    { 
        text: "The customer said the sandwich was delicious and that they would definitely come back again.",
        id: "item5"
    }
];
...
const question3Content = [
    { 
        text: "It was my first time visiting a new local coffee shop.",
        id: "item1"
    },
    { 
        text: "At first, I didn’t think it would be good, but I decided to give it a try.",
        id: "item2"
    },
    { 
        text: "I looked at the menu and saw many different kinds of food and drinks.",
        id: "item3"
    },
    { 
        text: "I chose one dish to try for myself.",
        id: "item4"
    },
    { 
        text: "When I tasted it, I found it really delicious and knew I would come back again.",
        id: "item5"
    }
];
...
const correctAnswersQuestion4 = ['B', 'A', 'A', 'D', 'D', 'B', 'C'];
