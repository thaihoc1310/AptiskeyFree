...
const questions2_answer = { 
    "question2": "In my free time, I enjoy reading books, watching movies, and listening to music. I also like exploring new places, cooking, and spending time with my friends and family."
};
...
const questions3_answer = { 
    "question3_1_answer": "I like to visit natural places like mountains, beaches, and national parks. I enjoy exploring new environments, connecting with nature, and experiencing different cultures through travel.",
    "question3_2_answer": "I decided to join the club because I love meeting new people, sharing common interests, and learning from others. I believe it's a great way to expand my knowledge and have fun.",
    "question3_3_answer": "While having a larger club can encourage more environmentally conscious behavior, it's not guaranteed. A club's size doesn't necessarily correlate with its members' level of awareness or commitment to the environment."
};
...
//----------------------------------------------------------------------
const questions4_main = "Dear member, the club wants to make a plan for the young people because they just love to stay home and play games.";
