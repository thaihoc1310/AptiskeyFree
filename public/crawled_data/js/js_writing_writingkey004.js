const key_id = "Bộ đề #004";
const club_name = "Business club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Where do you usually go shopping?",
};
const questions2_answer = { 
    "question2": "I usually shop at premium stores in the city center for business attire and essentials. For gadgets, I prefer specialized outlets or online platforms." 
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "I know there are a lot of successful small businesses these days. Tell me about a successful small business in your area.",
    "question3_2": "I have a friend who wants to open a second coffee shop. She opened her first one a year ago and it was quite successful. What advice do you have to help her be more successful in her second shop?",
    "question3_3": "Can you tell me what qualities and skills are needed to create a successful small business?"
};

const questions3_answer = { 
    "question3_1_answer": "In my area, a bakery has become successful due to its high-quality products and friendly service. It expanded by offering unique recipes and became a local favorite. People recommend it to others.",
    "question3_2_answer": "For the second shop, she should maintain product quality and focus on customer service. Choosing a good location, promoting on social media, and creating special promotions can help attract more customers and keep them loyal.",
    "question3_3_answer": "To build a successful small business, one needs qualities like perseverance, creativity, and adaptability. Important skills include problem-solving, communication, marketing, and the ability to understand customer needs and provide quality service."
};



//----------------------------------------------------------------------
const questions4_main = "Currently our club is planning to support local individuals who want to start up a small business. The club has 2 proposals: First, create a call center where customers can call to ask questions and request help. Second, create free courses to support local universities nearby. Let us know which option you would use and why.";
const question4_1_text = "Write a short email to your friend (about 50 words). Write a letter to a friend about your choice and the idea.";
const question4_2_text = "Write an email to the president of the club (about 120-150 words). Write a letter to the club manager about your choice and why.";


const question4_1_text_answer = `Hi Hang, <br>
...
const question4_2_text_answer = `Dear Club President, <br>
