const key_id = "Bộ đề #016";
const club_name = "Garden club";  
//----------------------------------------------------------------------
const questions1 = {
...
const questions2_answer = { 
    "question2": "I joined the garden club because I love plants and gardening. I want to learn more about growing different types of plants and how to take care of them."
};
...
const questions3_answer = { 
    "question3_1_answer": "My garden is small but cozy, with lots of flowers and a few vegetable plants. I have a small area for relaxing, and I love spending time there, especially in the morning.",
    "question3_2_answer": "Yes, gardening is quite popular in my country. Many people enjoy growing flowers, vegetables, and fruits. It’s a great way to relax and connect with nature while having fresh produce.",
    "question3_3_answer": "My favorite season is spring because the weather is mild, and everything starts to bloom. It’s a time of renewal, and I love seeing the flowers and trees come to life."
};
