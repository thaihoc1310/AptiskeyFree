...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Tell me a place you often visit?",
};
const questions2_answer = { 
    "question2": "I often visit a nearby park. It’s a peaceful place where I enjoy walking, reading, or just relaxing. I love the natural surroundings and the fresh air there."
};

//----------------------------------------------------------------------
const questions3 = {
    "question3_1": "What is the most exciting journey you’ve been on?",
    "question3_2": "Can you remember the first time you went on a journey by yourself? What was it like?",
    "question3_3": "Some people like taking photos when they have vacation. Your opinion?"
};

const questions3_answer = { 
    "question3_1_answer": "The most exciting journey I’ve been on was a trip to the mountains last year. I hiked through beautiful trails, enjoyed stunning views, and experienced the thrill of being surrounded by nature.",
    "question3_2_answer": "I remember my first solo journey when I traveled to a nearby city. It was both exciting and intimidating, but I learned so much about independence, navigation, and making new connections.",
    "question3_3_answer": "I believe taking photos during vacations is a great way to preserve memories and capture beautiful moments. It allows us to relive the experiences and share them with others, making the trip more memorable."
};
...
//----------------------------------------------------------------------
const questions4_main = "Dear members, the club wants members to give their opinions to make it easier for those traveling abroad for the first time and suggest the best way to communicate easily abroad. Please raise your voice and give some suggestions.";
