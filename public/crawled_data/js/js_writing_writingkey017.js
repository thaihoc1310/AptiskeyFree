const key_id = "Bộ đề #017";
const club_name = "Healthy club";  
//----------------------------------------------------------------------
const questions1 = {
...
//----------------------------------------------------------------------
const questions2 = {
    "question2": "Tell me the classes you want to take and what times and days are suitable for you?",
};
const questions2_answer = { 
    "question2": "I would like to take yoga and cardio classes. I’m available on weekdays in the evenings, preferably around 6 PM. Weekend morning sessions would also work for me."
};
...
const questions3 = {
    ...
    "question3_3": "A manager of Fitness club has an announcement for club’s members"
};

const questions3_answer = { 
    "question3_1_answer": "I heard about the club from a friend who has been a member for a while. She recommended it because of the great facilities and friendly atmosphere, so I decided to join.",
    "question3_2_answer": "By joining the club, I hope to improve my overall fitness, learn new exercises, and make healthier lifestyle choices. I also want to meet new people who share similar fitness goals.",
    "question3_3_answer": "The manager of the Fitness Club has announced new fitness classes starting next month. Members can sign up for a variety of classes including yoga, pilates, and high-intensity training."
};



//----------------------------------------------------------------------
const questions4_main = "Dear all, Because of personal reasons, the instructor will be away for the next two weeks. We will use our facilities by ourselves without the assistance of an instructor. I am so sorry about this situation and hope you doing well in next two weeks";
